...
public class ActivityTravelStatisty extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SetTitleBackground
				.setTitleBg(ActivityTravelStatisty.this, R.color.color_4);
	...
	private void showGetTimeView(final boolean isStart) {
		final Dialog dialog = new Dialog(ActivityTravelStatisty.this,
				R.style.dialog);
	...
	private void showSelectTimeView() {
		dialog = dialog == null ? new Dialog(ActivityTravelStatisty.this,
