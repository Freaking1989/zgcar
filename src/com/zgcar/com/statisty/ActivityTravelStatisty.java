...
/**
 * @author Freaking 运行总览
 */
public class ActivityTravelStatisty extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SetTitleBackground.setTitleBg(ActivityTravelStatisty.this,
				R.color.color_4);
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_travel_statisty);
		init();
		showProgressDialog();
		getInfosRequest();
	}
	...
	private void init() {
		...
		ImageButton back = (ImageButton) findViewById(R.id.travel_statistics_back);
		back.setOnClickListener(this);
		Button selectTime = (Button) findViewById(R.id.travel_statistics_select_time);
		selectTime.setOnClickListener(this);
		timeTv = (TextView) findViewById(R.id.travel_statistics_time_tv);
	}

	@Override
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.travel_statistics_back:
			finish();
			break;
		case R.id.travel_statistics_select_time:
			showSelectTimeView();
			break;
		...
		new Thread(new Runnable() {
			...
			public void run() {
				String jsonStr = GetJsonString.getRequestJson(
						FinalVariableLibrary.RUN_SRATISTICS, app.getImei(), "",
						"");
				...
				if (flag1) {
					...
					Looper.prepare();
					dialogDismiss();
					Util.showToastBottom(ActivityTravelStatisty.this,
							SocketUtil.isFail(ActivityTravelStatisty.this));
					Looper.loop();
					return;
				}
			}
	...
	private void showGetTimeView(final boolean isStart) {
		...
		View view = View.inflate(ActivityTravelStatisty.this,
		...
		month.setViewAdapter(new ArrayWheelAdapter<String>(
				ActivityTravelStatisty.this, monthArray));
		...
		wheelView.setViewAdapter(new ArrayWheelAdapter<String>(
				ActivityTravelStatisty.this, new String[] { "-" }));
	...
	public Dialog getDialog() {
		return dialog == null ? new Dialog(ActivityTravelStatisty.this,
