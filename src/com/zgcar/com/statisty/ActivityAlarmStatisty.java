...
public class ActivityAlarmStatisty extends Activity implements OnClickListener,
	...
	private void init() {
		...
		ImageButton back = (ImageButton) findViewById(R.id.report_statistics_back);
		back.setOnClickListener(this);
		Button selectTime = (Button) findViewById(R.id.report_statistics_select_time);
		selectTime.setOnClickListener(this);
		timeTv = (TextView) findViewById(R.id.report_statistics_time_tv);
	}

	@Override
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.report_statistics_back:
			finish();
			break;
		case R.id.report_statistics_select_time:
			showSelectTimeView();
			break;
	...
	private void showGetTimeView(final boolean isStart) {
		...
		month.setViewAdapter(new ArrayWheelAdapter<String>(
				ActivityAlarmStatisty.this, monthArray));
		...
		wheelView.setViewAdapter(new ArrayWheelAdapter<String>(
				ActivityAlarmStatisty.this, new String[] { "-" }));
