...
public class ActivityAccStatisty extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SetTitleBackground
				.setTitleBg(ActivityAccStatisty.this, R.color.color_4);
	...
	private void init() {
		...
		ImageButton back = (ImageButton) findViewById(R.id.acc_statistics_back);
		back.setOnClickListener(this);
		Button selectTime = (Button) findViewById(R.id.acc_statistics_select_time);
		selectTime.setOnClickListener(this);
		timeTv = (TextView) findViewById(R.id.acc_statistics_time_tv);
	}

	@Override
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.acc_statistics_back:
			finish();
			break;
		case R.id.acc_statistics_select_time:
			showSelectTimeView();
			break;
	...
	private void showGetTimeView(final boolean isStart) {
		...
		month.setViewAdapter(new ArrayWheelAdapter<String>(
				ActivityAccStatisty.this, monthArray));
		...
		wheelView.setViewAdapter(new ArrayWheelAdapter<String>(
				ActivityAccStatisty.this, new String[] { "-" }));
