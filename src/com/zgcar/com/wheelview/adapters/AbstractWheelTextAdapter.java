 ...
 */
package com.zgcar.com.wheelview.adapters;
...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
		...
		if (index >= 0 && index < getItemsCount()) {
			...
			if (textView != null) {
				...
				if (itemResourceId == TEXT_VIEW_ITEM_RESOURCE) {
					configureTextView(textView, textSize, gravity);
				}
			}
			return convertView;
		}
	...
	public View getEmptyItem(View convertView, ViewGroup parent) {
		...
		if (emptyItemResourceId == TEXT_VIEW_ITEM_RESOURCE
			...
			configureTextView((TextView) convertView, 0, 17);
		}
	 ...
	 */
	protected void configureTextView(TextView view, int textSize1, int gravity) {
		view.setTextColor(textColor);
		// 17//5//3
		view.setGravity(gravity);

		if (textSize1 != 0) {
			view.setTextSize(textSize1);
		} else {
