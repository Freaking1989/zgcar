...
import com.zgcar.com.zxing.decoding.ScanningActivityHandler;
 ...
 * 
 */
public class ActivityScanning extends Activity implements Callback {
	...
	private Button scannig_addimiesim;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		SetTitleBackground.setTitleBg(ActivityScanning.this, R.color.color_4);
		...
		ImageButton back = (ImageButton) findViewById(R.id.scanning_back);
		...
		scannig_addimiesim = (Button) findViewById(R.id.scannig_addimiesim);
		scannig_addimiesim.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				Intent in = new Intent(ActivityScanning.this,
						ActivityBindingImei.class);
				in.putExtra("imei", "");
				startActivity(in);
				finish();
			}
	...
	private void initCamera(SurfaceHolder surfaceHolder) {
		...
		if (handler == null) {
			handler = new ScanningActivityHandler(this, decodeFormats,
					characterSet);
		}
	}
